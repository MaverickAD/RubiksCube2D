...
if (location.search == "") {
    a = new Game(["#aba5a7","#ff0000","#000000","#00ff00","#aba5a7"
    ...
    a = new Game(board, board_, 5)
    document.getElementById("mod").innerHTML = "maker 5x5";
    document.querySelector("title").innerHTML = "maker 5x5";
}
