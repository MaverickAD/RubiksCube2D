...
let a = new Game(["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"
                 ...
                 ,"#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"
                 ,"#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"
                 ,"#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"], 8);
...
confirm.onclick = (
    () => {
        ...
        res = res.replace(/\s+/g, "")
        window.location.href = "../adventurePage/adventure6.html?a=" + res   
})