...
let a = new Game(["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"
                 ...
                 ,"#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"
                 ,"#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"
                 ,"#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"], 5);
...
confirm.onclick = (
    () => {
        ...
        res = res.replace(/\s+/g, "")
        window.location.href = "../adventurePage/adventure3.html?a=" + res   
})