...
let a = new Game(["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"
                 ...
                 ,"#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"
                 ,"#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"
                 ,"#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"], 6);
...
confirm.onclick = (
    () => {
        ...
        res = res.replace(/\s+/g, "")
        window.location.href = "../adventurePage/adventure4.html?a=" + res   
})