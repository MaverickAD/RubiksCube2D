...
let a = new Game(["#ffffff","#ffffff","#ffffff","#ffffff"
...
confirm.onclick = (
    () => {
        ...
        res = res.replace(/\s+/g, "")
        window.location.href = "../adventurePage/adventure2.html?a=" + res   
})