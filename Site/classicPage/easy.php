...
if (array_key_exists("Pseudo", $_POST)) {
    ...
    $monfichier = fopen('leaderboard.txt', 'a+'); 
...
<body>
    ...
    <nav class="nav">
        <ul>
            <li><a href="#" id="navBar_adventureTitle" onclick="toggleNav()">Adventure mode</a></li>
    ...
    <div class="filter" id="blur">
        ...
        <main id="classic-main-mod">
            ...
            <div id="popup">
                ...
                <div id="boite-jeu">
                    <div id="buttons_up"></div>
                    <div id="petite-boite-jeu">
                        <div id="buttons_left"></div>
                        <div class="box" id="game"></div>
                        <div id="buttons_right"></div>
                    </div>
                    <div id="buttons_down"></div>
                </div>
